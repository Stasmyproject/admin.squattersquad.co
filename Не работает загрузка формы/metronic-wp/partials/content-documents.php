                                        ...
                                        <div class="col-sm-6 col-xxl-3">
                                            ...
                                            <div class="card card-flush h-xl-100">
                                                ...
                                                <div class="card-body text-center pb-5">
                                                    ...
                                                    <?php
                                                    $image_url = get_template_directory_uri() . '/metronic/assets/media/stock/600x600/img-39.jpg';
                                                    ?>

                                                    <!--begin::Overlay-->
                                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="<?php echo esc_url($image_url); ?>">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                                             style="height: 266px; background-image: url('<?php echo esc_url($image_url); ?>');">
                                                        </div>
                                                        <!--end::Image-->
                                                    ...
                                                    <div class="d-flex align-items-end flex-stack mb-1">
                                                        ...
                                                        <div class="text-start">
                                                            <span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Notice to Vacate</span>
                                                            <span class="text-gray-500 mt-1 fw-bold fs-6">Cost:</span>
                                                        </div>
                                                        <!--end::Title-->
                                                        <!--begin::Total-->
                                                        <span class="text-gray-600 text-end fw-bold fs-6">$30</span>
                                                        <!--end::Total-->
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-xxl-3">
                                            ...
                                            <div class="card card-flush h-xl-100">
                                                ...
                                                <div class="card-body text-center pb-5">
                                                    ...
                                                    <?php
                                                    $image_url = get_template_directory_uri() . '/metronic/assets/media/stock/600x600/img-40.jpg';
                                                    ?>
                                                    ...
                                                    <div class="d-flex align-items-end flex-stack mb-1">
                                                        <!--begin::Title-->
                                                        <div class="text-start">
                                                            <span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Cease and Desist Letter</span>
                                                            <span class="text-gray-500 mt-1 fw-bold fs-6">Cost:</span>
                                                        </div>
                                                        <!--end::Title-->
                                                        <!--begin::Total-->
                                                ...
                                                <div class="card-footer d-flex flex-stack pt-0">
                                                    <!--begin::Link-->
                                                    <a class="btn btn-sm btn-primary flex-shrink-0 me-2" data-bs-target="#kt_modal_bidding" data-bs-toggle="modal">Bay</a>
                                                    <!--end::Link-->
                                                    <!--begin::Link-->
                                                    <a class="btn btn-sm btn-light flex-shrink-0" href="apps/ecommerce/sales/listing.html">Сreate Document</a>
                                                    <!--end::Link-->
                                                </div>
                                                <!--end::Footer-->
                                            </div>
                                        ...
                                        <div class="col-sm-6 col-xxl-3">
                                            ...
                                            <div class="card card-flush h-xl-100">
                                                ...
                                                <div class="card-body text-center pb-5">
                                                    ...
                                                    <?php
                                                    $image_url = get_template_directory_uri() . '/metronic/assets/media/stock/600x600/img-41.jpg';
                                                    ?>
                                                    ...
                                                    <div class="d-flex align-items-end flex-stack mb-1">
                                                        <!--begin::Title-->
                                                        <div class="text-start">
                                                            <span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Trespass Warning Notice</span>
                                                            <span class="text-gray-500 mt-1 fw-bold fs-6">Cost</span>
                                                        </div>
                                                        <!--end::Title-->
                                                        <!--begin::Total-->
                                                        <span class="text-gray-600 text-end fw-bold fs-6">$35</span>
                                                        <!--end::Total-->
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-xxl-3">
                                            ...
                                            <div class="card card-flush h-xl-100">
                                                ...
                                                <div class="card-body text-center pb-5">
                                                    ...
                                                    <?php
                                                    $image_url = get_template_directory_uri() . '/metronic/assets/media/stock/600x600/img-44.jpg';
                                                    ?>
                                                    ...
                                                    <div class="d-flex align-items-end flex-stack mb-1">
                                                        <!--begin::Title-->
                                                        <div class="text-start">
                                                            <span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Affidavit of Property Ownership</span>
                                                            <span class="text-gray-500 mt-1 fw-bold fs-6">Cost</span>
                                                        </div>
                                                        <!--end::Title-->
                                                        <!--begin::Total-->
                                                        <span class="text-gray-600 text-end fw-bold fs-6">$40</span>
                                                        <!--end::Total-->
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                                ...
                                                <div class="card-body d-flex align-items-end pt-0">
                                                    ...
                                                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                                                        ...
                                                        <div class="h-8px mx-3 w-100 bg-light-danger rounded">
                                                            <div class="bg-danger rounded h-8px" role="progressbar" style="width: 32%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </div>
                                                    <!--end::Progress-->
                                                </div>
