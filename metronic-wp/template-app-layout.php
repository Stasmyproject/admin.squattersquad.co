...
// Определим текущий slug страницы
$current_slug = basename(get_page_uri());

// Проверим, является ли это формой
$is_form_page = str_starts_with($current_slug, 'form-');

// Инициализация ID черновика проекта
$draft_project_id = 0;
...
?>
        ...
        -->
                            ...
                            <div id="kt_app_sidebar_toggle"
                                 class="<?php echo esc_attr($toggle_button_class); ?>"
                                 data-kt-toggle="true"
