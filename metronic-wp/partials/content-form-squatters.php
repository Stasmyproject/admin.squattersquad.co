...
?>
                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid" >
                                ...
                                <div id="kt_app_content_container" class="app-container container-xxl">
                                    ...
                                    <!--begin::Form Wrapper (скрыт по умолчанию)-->
                                    <div id="form_wrapper" style="display: none;">
                                        <div class="card-flush py-4 form-wizard" data-project-id="<?php echo esc_attr($project_id); ?>">
                                            <!-- Твои шаги формы -->
                                            ...
                                            <div class="card mb-5 mb-xl-10 form-wizard" data-project-id="<?php echo esc_attr($project_id); ?>">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <!-- begin:Step9 Адресс--> 
                                                    <div class="form-step step-9" data-step="9">
                                                    ...
                                                    <!-- begin:Step 10 Регистрационные данные--> 
                                                    <div class="form-step step-10" data-step="10">
                                                        ...
                                                        <div class="text-center mb-5 mt-5">
                                                            ...
                                                            <!--begin::Title-->
                                                            <label class=" form-label fs-2hx text-gray-900 mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">Enter your current data</label>
                                                            <!--end::Title-->

                                                            <!--begin::Text-->
                                                            <div class="fs-5 text-muted fw-bold">These data are necessary for authorization and registration of you in the system, if you already have registration on our site authorize. </div>
                                                            <!--end::Text-->
                                                        </div>
                                                        <!--end::Heading-->
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 fv-row">
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <input type="text" placeholder="Phone (Required)" name="phone" autocomplete="off" class="form-control bg-transparent">
                                                                        <!--end::Phone-->
                                                                    </div> 
                                                                </div>
                                                    ...
                                                    <!-- end:Step 10 Регистрационные данные-->

                                                    <!-- begin:Step 11 Платежные рквизиты и планы услуг--> 
                                                    <div class="form-step step-10" data-step="10">
                                                        ...
                                                        <div class="text-center mb-5 mt-5">
                                                            ...
                                                            <!--begin::Title-->
                                                            <label class=" form-label fs-2hx text-gray-900 mb-5" id="how-it-works" data-kt-scroll-offset="{default: 100, lg: 150}">Choose the right package</label>
                                                            <!--end::Title-->
                                                    ...
                                                    <!-- end:Step 11 Платежные рквизиты и планы услуг-->
                                                </div>
                                            </div>
