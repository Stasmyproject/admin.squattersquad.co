...
// 🔐 Если не авторизован тогда создаём/получаем draft-проект
if (!$is_logged_in) {
    // Неавторизованный пользователь — создаём/получаем draft-проект
    ...
    if (!$draft_project_id || get_post_type($draft_project_id) !== 'project') {
        $draft_project_id = wp_insert_post([
            'post_type'   => 'project',
            'post_status' => 'draft',
        ...
        setcookie('draft_project_id', $draft_project_id, time() + 3600, '/');
        $_COOKIE['draft_project_id'] = $draft_project_id;
    }
} else {
    // 🔐 Авторизованный пользователь — получаем ID
    $current_user = wp_get_current_user();
    $user_id = $current_user->ID;
    $draft_project_id = 0;
    // Здесь при необходимости можно получить активный проект пользователя
}
?>
...
<!-- Begin::Metronic Wrapper -->
    ...
    class="app-default <?php echo current_user_can('administrator') ? 'admin-bar-visible' : ''; ?>">
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                ...
                <?php if ($is_logged_in): ?>
                    <!--begin::Header-->
                    <?php get_template_part('partials/header-dashdoards'); ?>
                    <!--end::Header-->
                <?php endif; ?>
                ...
                <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                    ...
                    <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                        ...
                        <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                            <!--begin::Logo image-->
                            <a href="index.html">
                                <img alt="Logo" src="<?php echo get_template_directory_uri(); ?>/metronic/assets/media/logos/custom-3.svg" class="h-25px app-sidebar-logo-default" />
                                <img alt="Logo" src="<?php echo get_template_directory_uri(); ?>/metronic/assets/media/logos/default-small.svg" class="h-20px app-sidebar-logo-minimize" />
                            </a>
                            <!--end::Logo image-->
        ...
        -->
                            ...
                            <div id="kt_app_sidebar_toggle" class="app-sidebar-toggle btn btn-icon btn-shadow btn-sm btn-color-muted btn-active-color-primary h-30px w-30px position-absolute top-50 start-100 translate-middle rotate<?php echo !$is_logged_in ? ' active' : ''; ?>" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="app-sidebar-minimize">
                        ...
                        <div id="kt_app_footer" class="app-footer">
                            ...
                            <div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
                                ...
                                <div class="text-gray-900 order-2 order-md-1">
                                    <span class="text-muted fw-semibold me-1">2020 - 2025&copy;</span>
                                    <a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Squattersquad.co</a>
                                </div>
                                <!--end::Copyright-->
                                <!--begin::Menu-->
