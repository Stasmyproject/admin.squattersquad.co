...
// }  
            ...
            <div class=" col-12 col-lg-6" id="doc-preview-wrapper">
                <div class=" dynamic-scale mx-auto" id="doc-print-content">
                    ...
                    <?php 
                        $preview_template_path = get_template_directory() . '/acf-templates/' . $slug . '.php';

                        if (file_exists($preview_template_path)) {
                            include($preview_template_path);
                        } else {
                            echo "<div class='alert alert-warning'>⚠️ Превью-шаблон не найден: <code>acf-templates/{$slug}.php</code></div>";
                        }
                    ?>
                </div>
            </div>
