...
<div class="container py-5">
    ...
    <?php if ($post_id): ?>
        ...
        $body_template = get_template_directory() . '/acf-templates/' . $template_slug . '-body.php';
        $template_status = file_exists($body_template) ? '✅ Найден' : '❌ Не найден';
        ?>
        ...
        <h2 class="mb-15">📄 Превью документа</h2>
            ...
            if (file_exists($body_template)) {
                $fields = get_fields($post_id);
                include get_template_directory() . '/acf-templates/base-template.php';
            } else {
