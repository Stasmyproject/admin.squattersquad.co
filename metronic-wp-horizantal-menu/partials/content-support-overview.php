										...
										<div class="card-body flex-column p-5">
											...
											<div class="d-flex align-items-center h-lg-300px p-5 p-lg-15">
												...
												<div class="flex-equal d-flex justify-content-center align-items-end ms-5">
													...
													<img src="<?php echo esc_url( get_template_directory_uri() . '/metronic/assets/media/illustrations/sketchy-1/20.png' ); ?>" alt="" class="mw-100 mh-125px mh-lg-275px mb-lg-n12" />
													<!--end::Illustration-->
												</div>
												<!--end::Wrapper-->
											</div>
